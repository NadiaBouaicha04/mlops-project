...
class OAuthCredentialsProvider:
    ...
    def __init__(
        self, credentials_provider: CredentialsProvider, token_provider: Callable[[], Token]
    ):
...
class OauthCredentialsStrategy(CredentialsStrategy):
    ...
    def __init__(
        self, auth_type: str, headers_provider: Callable[["Config"], OAuthCredentialsProvider]
    ):
...
class CliTokenSource(Refreshable):
    ...
    def __init__(
        self, cmd: List[str], token_type_field: str, access_token_field: str, expiry_field: str
    ):
        super().__init__()
        self._cmd = cmd
...
class AzureCliTokenSource(CliTokenSource):
    ...
    def __init__(
        self, resource: str, subscription: Optional[str] = None, tenant: Optional[str] = None
    ):
