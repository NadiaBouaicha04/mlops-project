...
class WorkspaceClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._account_access_control_proxy = service.iam.AccountAccessControlProxyAPI(
            self._api_client
        )
        ...
        self._consumer_installations = service.marketplace.ConsumerInstallationsAPI(
            self._api_client
        )
        self._consumer_listings = service.marketplace.ConsumerListingsAPI(self._api_client)
        self._consumer_personalization_requests = (
            service.marketplace.ConsumerPersonalizationRequestsAPI(self._api_client)
        )
        ...
        self._notification_destinations = service.settings.NotificationDestinationsAPI(
            self._api_client
        )
        ...
        self._provider_exchange_filters = service.marketplace.ProviderExchangeFiltersAPI(
            self._api_client
        )
        ...
        self._provider_personalization_requests = (
            service.marketplace.ProviderPersonalizationRequestsAPI(self._api_client)
        )
        self._provider_provider_analytics_dashboards = (
            service.marketplace.ProviderProviderAnalyticsDashboardsAPI(self._api_client)
        )
        ...
        self._query_visualizations_legacy = service.sql.QueryVisualizationsLegacyAPI(
            self._api_client
        )
        ...
        self._temporary_table_credentials = service.catalog.TemporaryTableCredentialsAPI(
            self._api_client
        )
        ...
        self._vector_search_endpoints = service.vectorsearch.VectorSearchEndpointsAPI(
            self._api_client
        )
...
class AccountClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._metastore_assignments = service.catalog.AccountMetastoreAssignmentsAPI(
            self._api_client
        )
        ...
        self._published_app_integration = service.oauth2.PublishedAppIntegrationAPI(
            self._api_client
        )
        self._service_principal_federation_policy = (
            service.oauth2.ServicePrincipalFederationPolicyAPI(self._api_client)
        )
        self._service_principal_secrets = service.oauth2.ServicePrincipalSecretsAPI(
            self._api_client
        )
