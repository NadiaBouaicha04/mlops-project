...
class AclItem:
    ...
    def from_dict(cls, d: Dict[str, any]) -> AclItem:
        ...
        return cls(
            permission=_enum(d, "permission", AclPermission), principal=d.get("principal", None)
        )
...
class CreateScope:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CreateScope:
        ...
        return cls(
            backend_azure_keyvault=_from_dict(
                d, "backend_azure_keyvault", AzureKeyVaultSecretScopeMetadata
            ),
...
class GetRepoPermissionLevelsResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetRepoPermissionLevelsResponse:
        ...
        return cls(
            permission_levels=_repeated_dict(d, "permission_levels", RepoPermissionsDescription)
        )
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetWorkspaceObjectPermissionLevelsResponse:
        ...
        return cls(
            permission_levels=_repeated_dict(
                d, "permission_levels", WorkspaceObjectPermissionsDescription
            )
        )
...
class SecretMetadata:
    ...
    def from_dict(cls, d: Dict[str, any]) -> SecretMetadata:
        ...
        return cls(
            key=d.get("key", None), last_updated_timestamp=d.get("last_updated_timestamp", None)
        )
    ...
    def from_dict(cls, d: Dict[str, any]) -> WorkspaceObjectPermissions:
        ...
        return cls(
            access_control_list=_repeated_dict(
                d, "access_control_list", WorkspaceObjectAccessControlResponse
            ),
            object_id=d.get("object_id", None),
            object_type=d.get("object_type", None),
        )
...
class WorkspaceObjectPermissionsRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> WorkspaceObjectPermissionsRequest:
        ...
        return cls(
            access_control_list=_repeated_dict(
                d, "access_control_list", WorkspaceObjectAccessControlRequest
            ),
...
class GitCredentialsAPI:
    ...
    def update(
        ...
        *,
        ...
        self._api.do(
            "PATCH", f"/api/2.0/git-credentials/{credential_id}", body=body, headers=headers
        )
...
class ReposAPI:
    ...
    def get_permission_levels(self, repo_id: str) -> GetRepoPermissionLevelsResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/permissions/repos/{repo_id}/permissionLevels", headers=headers
        )
    ...
    def list(
        self, *, next_page_token: Optional[str] = None, path_prefix: Optional[str] = None
    ) -> Iterator[RepoInfo]:
        """Get repos.
    ...
    def set_permissions(
        ...
        res = self._api.do(
            "PUT", f"/api/2.0/permissions/repos/{repo_id}", body=body, headers=headers
        )
        return RepoPermissions.from_dict(res)
    ...
    def update_permissions(
        ...
        res = self._api.do(
            "PATCH", f"/api/2.0/permissions/repos/{repo_id}", body=body, headers=headers
        )
        return RepoPermissions.from_dict(res)
...
class WorkspaceAPI:
    ...
    def list(
        self, path: str, *, notebooks_modified_after: Optional[int] = None
    ) -> Iterator[ObjectInfo]:
        """List contents.
