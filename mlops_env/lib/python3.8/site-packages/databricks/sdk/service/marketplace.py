...
class CreateFileResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CreateFileResponse:
        ...
        return cls(
            file_info=_from_dict(d, "file_info", FileInfo), upload_url=d.get("upload_url", None)
        )
...
class GetPersonalizationRequestResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetPersonalizationRequestResponse:
        ...
        return cls(
            personalization_requests=_repeated_dict(
                d, "personalization_requests", PersonalizationRequest
            )
        )
...
class ListingDetail:
    ...
    def as_dict(self) -> dict:
        ...
        if self.embedded_notebook_file_infos:
            body["embedded_notebook_file_infos"] = [
                v.as_dict() for v in self.embedded_notebook_file_infos
            ]
        if self.file_ids:
    ...
    def from_dict(cls, d: Dict[str, any]) -> ListingDetail:
        ...
        return cls(
            ...
            embedded_notebook_file_infos=_repeated_dict(
                d, "embedded_notebook_file_infos", FileInfo
            ),
...
class ListingTag:
    ...
    def from_dict(cls, d: Dict[str, any]) -> ListingTag:
        ...
        return cls(
            tag_name=_enum(d, "tag_name", ListingTagType), tag_values=d.get("tag_values", None)
        )
...
class ConsumerInstallationsAPI:
    ...
    def list(
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.1/marketplace-consumer/installations", query=query, headers=headers
            )
...
class ConsumerListingsAPI:
    ...
    def batch_get(self, *, ids: Optional[List[str]] = None) -> BatchGetListingsResponse:
        ...
        res = self._api.do(
            "GET", "/api/2.1/marketplace-consumer/listings:batchGet", query=query, headers=headers
        )
    ...
    def list(
        ...
        *,
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.1/marketplace-consumer/listings", query=query, headers=headers
            )
            if "listings" in json:
    ...
    def search(
        ...
        *,
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.1/marketplace-consumer/search-listings", query=query, headers=headers
            )
            if "listings" in json:
                for v in json["listings"]:
                    yield Listing.from_dict(v)
...
class ConsumerProvidersAPI:
    ...
    def batch_get(self, *, ids: Optional[List[str]] = None) -> BatchGetProvidersResponse:
        ...
        res = self._api.do(
            "GET", "/api/2.1/marketplace-consumer/providers:batchGet", query=query, headers=headers
        )
    ...
    def list(
        ...
        *,
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.1/marketplace-consumer/providers", query=query, headers=headers
            )
...
class ProviderExchangeFiltersAPI:
    ...
    def create(self, filter: ExchangeFilter) -> CreateExchangeFilterResponse:
        ...
        res = self._api.do(
            "POST", "/api/2.0/marketplace-exchange/filters", body=body, headers=headers
        )
    ...
    def list(
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/marketplace-exchange/filters", query=query, headers=headers
            )
            if "filters" in json:
    ...
    def update(self, id: str, filter: ExchangeFilter) -> UpdateExchangeFilterResponse:
        ...
        res = self._api.do(
            "PUT", f"/api/2.0/marketplace-exchange/filters/{id}", body=body, headers=headers
        )
...
class ProviderExchangesAPI:
    ...
    def add_listing_to_exchange(
        self, listing_id: str, exchange_id: str
    ...
    def create(self, exchange: Exchange) -> CreateExchangeResponse:
        ...
        res = self._api.do(
            "POST", "/api/2.0/marketplace-exchange/exchanges", body=body, headers=headers
        )
    ...
    def delete_listing_from_exchange(self, id: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.0/marketplace-exchange/exchanges-for-listing/{id}", headers=headers
        )
    ...
    def list(
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/marketplace-exchange/exchanges", query=query, headers=headers
            )
    ...
    def update(self, id: str, exchange: Exchange) -> UpdateExchangeResponse:
        ...
        res = self._api.do(
            "PUT", f"/api/2.0/marketplace-exchange/exchanges/{id}", body=body, headers=headers
        )
...
class ProviderFilesAPI:
    ...
    def create(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.0/marketplace-provider/files", body=body, headers=headers
        )
    ...
    def list(
        ...
        *,
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/marketplace-provider/files", query=query, headers=headers
            )
...
class ProviderListingsAPI:
    ...
    def create(self, listing: Listing) -> CreateListingResponse:
        ...
        res = self._api.do(
            "POST", "/api/2.0/marketplace-provider/listing", body=body, headers=headers
        )
    ...
    def list(
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/marketplace-provider/listings", query=query, headers=headers
            )
            if "listings" in json:
                for v in json["listings"]:
                    yield Listing.from_dict(v)
    ...
    def update(self, id: str, listing: Listing) -> UpdateListingResponse:
        ...
        res = self._api.do(
            "PUT", f"/api/2.0/marketplace-provider/listings/{id}", body=body, headers=headers
        )
...
class ProviderProviderAnalyticsDashboardsAPI:
    ...
    def create(self) -> ProviderAnalyticsDashboard:
        ...
        res = self._api.do(
            "POST", "/api/2.0/marketplace-provider/analytics_dashboard", headers=headers
        )
    ...
    def get(self) -> ListProviderAnalyticsDashboardResponse:
        ...
        res = self._api.do(
            "GET", "/api/2.0/marketplace-provider/analytics_dashboard", headers=headers
        )
    ...
    def get_latest_version(self) -> GetLatestVersionProviderAnalyticsDashboardResponse:
        ...
        res = self._api.do(
            "GET", "/api/2.0/marketplace-provider/analytics_dashboard/latest", headers=headers
        )
        return GetLatestVersionProviderAnalyticsDashboardResponse.from_dict(res)

    def update(
        self, id: str, *, version: Optional[int] = None
...
class ProviderProvidersAPI:
    ...
    def create(self, provider: ProviderInfo) -> CreateProviderResponse:
        ...
        res = self._api.do(
            "POST", "/api/2.0/marketplace-provider/provider", body=body, headers=headers
        )
    ...
    def list(
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/marketplace-provider/providers", query=query, headers=headers
            )
            if "providers" in json:
                for v in json["providers"]:
                    yield ProviderInfo.from_dict(v)
    ...
    def update(self, id: str, provider: ProviderInfo) -> UpdateProviderResponse:
        ...
        res = self._api.do(
            "PUT", f"/api/2.0/marketplace-provider/providers/{id}", body=body, headers=headers
        )
