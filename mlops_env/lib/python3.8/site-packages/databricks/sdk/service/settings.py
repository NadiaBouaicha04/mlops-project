    ...
    def from_dict(cls, d: Dict[str, any]) -> AibiDashboardEmbeddingAccessPolicy:
        ...
        return cls(
            access_policy_type=_enum(
                d, "access_policy_type", AibiDashboardEmbeddingAccessPolicyAccessPolicyType
            )
        )
...
class ClusterAutoRestartMessageMaintenanceWindowWeekDayBasedSchedule:
    ...
    def from_dict(
        ...
        return cls(
            ...
            frequency=_enum(
                d, "frequency", ClusterAutoRestartMessageMaintenanceWindowWeekDayFrequency
            ),
    ...
    def from_dict(cls, d: Dict[str, any]) -> EgressNetworkPolicyInternetAccessPolicy:
        ...
        return cls(
            ...
            restriction_mode=_enum(
                d, "restriction_mode", EgressNetworkPolicyInternetAccessPolicyRestrictionMode
            ),
        )
    ...
    def from_dict(cls, d: Dict[str, any]) -> EgressNetworkPolicyInternetAccessPolicyLogOnlyMode:
        ...
        return cls(
            ...
            workloads=_repeated_enum(
                d, "workloads", EgressNetworkPolicyInternetAccessPolicyLogOnlyModeWorkloadType
            ),
        )
...
class GetTokenPermissionLevelsResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetTokenPermissionLevelsResponse:
        ...
        return cls(
            permission_levels=_repeated_dict(d, "permission_levels", TokenPermissionsDescription)
        )
...
class TokenPermissionsRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> TokenPermissionsRequest:
        ...
        return cls(
            access_control_list=_repeated_dict(d, "access_control_list", TokenAccessControlRequest)
        )
...
class AccountIpAccessListsAPI:
    ...
    def list(self) -> Iterator[IpAccessListInfo]:
        ...
        json = self._api.do(
            "GET", f"/api/2.0/accounts/{self._api.account_id}/ip-access-lists", headers=headers
        )
...
class CredentialsManagerAPI:
    ...
    def exchange_token(
        ...
        res = self._api.do(
            "POST", "/api/2.0/credentials-manager/exchange-tokens/token", body=body, headers=headers
        )
...
class IpAccessListsAPI:
    ...
    def replace(
        ...
        *,
        ...
        self._api.do(
            "PUT", f"/api/2.0/ip-access-lists/{ip_access_list_id}", body=body, headers=headers
        )
    ...
    def update(
        ...
        * For all allow lists and block lists combined, the API supports a maximum of 1000 IP/CIDR values,
        ...
        self._api.do(
            "PATCH", f"/api/2.0/ip-access-lists/{ip_access_list_id}", body=body, headers=headers
        )
...
class NotificationDestinationsAPI:
    ...
    def list(
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/notification-destinations", query=query, headers=headers
            )
            if "results" in json:
    ...
    def update(
        ...
        res = self._api.do(
            "PATCH", f"/api/2.0/notification-destinations/{id}", body=body, headers=headers
        )
        return NotificationDestination.from_dict(res)
...
class SettingsAPI:
    ...
    def __init__(self, api_client):
        ...
        self._aibi_dashboard_embedding_access_policy = AibiDashboardEmbeddingAccessPolicyAPI(
            self._api
        )
        self._aibi_dashboard_embedding_approved_domains = AibiDashboardEmbeddingApprovedDomainsAPI(
            self._api
        )
...
class TokenManagementAPI:
    ...
    def create_obo_token(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.0/token-management/on-behalf-of/tokens", body=body, headers=headers
        )
    ...
    def get_permission_levels(self) -> GetTokenPermissionLevelsResponse:
        ...
        res = self._api.do(
            "GET", "/api/2.0/permissions/authorization/tokens/permissionLevels", headers=headers
        )
    ...
    def set_permissions(
        ...
        res = self._api.do(
            "PUT", "/api/2.0/permissions/authorization/tokens", body=body, headers=headers
        )
        return TokenPermissions.from_dict(res)
    ...
    def update_permissions(
        ...
        res = self._api.do(
            "PATCH", "/api/2.0/permissions/authorization/tokens", body=body, headers=headers
        )
        return TokenPermissions.from_dict(res)
