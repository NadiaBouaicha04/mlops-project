...
class GetPasswordPermissionLevelsResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetPasswordPermissionLevelsResponse:
        ...
        return cls(
            permission_levels=_repeated_dict(d, "permission_levels", PasswordPermissionsDescription)
        )
    ...
    def from_dict(cls, d: Dict[str, any]) -> PasswordPermissions:
        ...
        return cls(
            access_control_list=_repeated_dict(
                d, "access_control_list", PasswordAccessControlResponse
            ),
            object_id=d.get("object_id", None),
            object_type=d.get("object_type", None),
        )
...
class PasswordPermissionsRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> PasswordPermissionsRequest:
        ...
        return cls(
            access_control_list=_repeated_dict(
                d, "access_control_list", PasswordAccessControlRequest
            )
        )
...
class UpdateRuleSetRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> UpdateRuleSetRequest:
        ...
        return cls(
            name=d.get("name", None), rule_set=_from_dict(d, "rule_set", RuleSetUpdateRequest)
        )
...
class AccessControlAPI:
    ...
    def check_policy(
        ...
        *,
        ...
        res = self._api.do(
            "GET", "/api/2.0/access-control/check-policy-v2", query=query, headers=headers
        )
...
class AccountAccessControlAPI:
    ...
    def get_assignable_roles_for_resource(
        self, resource: str
...
class AccountAccessControlProxyAPI:
    ...
    def update_rule_set(self, name: str, rule_set: RuleSetUpdateRequest) -> RuleSetResponse:
        ...
        res = self._api.do(
            "PUT", "/api/2.0/preview/accounts/access-control/rule-sets", body=body, headers=headers
        )
        return RuleSetResponse.from_dict(res)
...
class AccountGroupsAPI:
    ...
    def get(self, id: str) -> Group:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/accounts/{self._api.account_id}/scim/v2/Groups/{id}", headers=headers
        )
        return Group.from_dict(res)
...
class GroupsAPI:
    ...
    def list(
        ...
        *,
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/preview/scim/v2/Groups", query=query, headers=headers
            )
            if "Resources" in json:
                for v in json["Resources"]:
                    i = v["id"]
...
class PermissionsAPI:
    ...
    * **[Workspace object permissions](:service:workspace)** — Manage which users can read, run, edit, or
    ...
    def get_permission_levels(
        self, request_object_type: str, request_object_id: str
...
class ServicePrincipalsAPI:
    ...
    def create(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.0/preview/scim/v2/ServicePrincipals", body=body, headers=headers
        )
        return ServicePrincipal.from_dict(res)
    ...
    def get(self, id: str) -> ServicePrincipal:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/preview/scim/v2/ServicePrincipals/{id}", headers=headers
        )
        return ServicePrincipal.from_dict(res)
    ...
    def list(
        ...
        *,
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/preview/scim/v2/ServicePrincipals", query=query, headers=headers
            )
            if "Resources" in json:
                for v in json["Resources"]:
                    i = v["id"]
    ...
    def patch(
        ...
        *,
        ...
        self._api.do(
            "PATCH", f"/api/2.0/preview/scim/v2/ServicePrincipals/{id}", body=body, headers=headers
        )
    ...
    def update(
        ...
        *,
        ...
        self._api.do(
            "PUT", f"/api/2.0/preview/scim/v2/ServicePrincipals/{id}", body=body, headers=headers
        )
...
class UsersAPI:
    ...
    def get(
        ...
        *,
        ...
        res = self._api.do(
            "GET", f"/api/2.0/preview/scim/v2/Users/{id}", query=query, headers=headers
        )
        return User.from_dict(res)
    ...
    def get_permission_levels(self) -> GetPasswordPermissionLevelsResponse:
        ...
        res = self._api.do(
            "GET", "/api/2.0/permissions/authorization/passwords/permissionLevels", headers=headers
        )
    ...
    def list(
        ...
        *,
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/preview/scim/v2/Users", query=query, headers=headers
            )
            if "Resources" in json:
                for v in json["Resources"]:
                    i = v["id"]
    ...
    def set_permissions(
        ...
        res = self._api.do(
            "PUT", "/api/2.0/permissions/authorization/passwords", body=body, headers=headers
        )
        return PasswordPermissions.from_dict(res)
    ...
    def update_permissions(
        ...
        res = self._api.do(
            "PATCH", "/api/2.0/permissions/authorization/passwords", body=body, headers=headers
        )
        return PasswordPermissions.from_dict(res)
