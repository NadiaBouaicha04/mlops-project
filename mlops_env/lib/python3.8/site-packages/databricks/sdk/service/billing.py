...
class BudgetConfigurationFilterTagClause:
    ...
    def from_dict(cls, d: Dict[str, any]) -> BudgetConfigurationFilterTagClause:
        ...
        return cls(
            key=d.get("key", None), value=_from_dict(d, "value", BudgetConfigurationFilterClause)
        )
...
class CreateBudgetConfigurationBudgetAlertConfigurations:
    action_configurations: Optional[List[CreateBudgetConfigurationBudgetActionConfigurations]] = (
        None
    )
    """Configured actions for this alert. These define what happens when an alert enters a triggered
    state."""
...
class GetBillingUsageDashboardResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetBillingUsageDashboardResponse:
        ...
        return cls(
            dashboard_id=d.get("dashboard_id", None), dashboard_url=d.get("dashboard_url", None)
        )
...
class WrappedLogDeliveryConfiguration:
    ...
    def from_dict(cls, d: Dict[str, any]) -> WrappedLogDeliveryConfiguration:
        ...
        return cls(
            log_delivery_configuration=_from_dict(
                d, "log_delivery_configuration", LogDeliveryConfiguration
            )
        )
...
class WrappedLogDeliveryConfigurations:
    ...
    def from_dict(cls, d: Dict[str, any]) -> WrappedLogDeliveryConfigurations:
        ...
        return cls(
            log_delivery_configurations=_repeated_dict(
                d, "log_delivery_configurations", LogDeliveryConfiguration
            )
        )
...
class BillableUsageAPI:
    ...
    def download(
        self, start_month: str, end_month: str, *, personal_data: Optional[bool] = None
    ) -> DownloadResponse:
...
class BudgetsAPI:
    ...
    def create(self, budget: CreateBudgetConfigurationBudget) -> CreateBudgetConfigurationResponse:
        ...
        res = self._api.do(
            "POST", f"/api/2.1/accounts/{self._api.account_id}/budgets", body=body, headers=headers
        )
    ...
    def get(self, budget_id: str) -> GetBudgetConfigurationResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.1/accounts/{self._api.account_id}/budgets/{budget_id}", headers=headers
        )
    ...
    def update(
        self, budget_id: str, budget: UpdateBudgetConfigurationBudget
