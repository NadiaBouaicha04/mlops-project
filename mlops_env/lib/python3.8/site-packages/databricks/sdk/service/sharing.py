...
class ProvidersAPI:
    ...
    def list(
        ...
        *,
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.1/unity-catalog/providers", query=query, headers=headers
            )
    ...
    def update(
        ...
        *,
        ...
        res = self._api.do(
            "PATCH", f"/api/2.1/unity-catalog/providers/{name}", body=body, headers=headers
        )
        return ProviderInfo.from_dict(res)
    ...
    **Databricks-to-Databricks sharing**.
    ...
    def list(
        ...
        * the caller is a metastore admin, or * the caller is the owner. There is no guarantee of a specific
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.1/unity-catalog/recipients", query=query, headers=headers
            )
    ...
    def update(
        ...
        *,
        ...
        res = self._api.do(
            "PATCH", f"/api/2.1/unity-catalog/recipients/{name}", body=body, headers=headers
        )
        return RecipientInfo.from_dict(res)
...
class SharesAPI:
    ...
    def create(
        self, name: str, *, comment: Optional[str] = None, storage_root: Optional[str] = None
    ) -> ShareInfo:
        """Create a share.
    ...
    def get(self, name: str, *, include_shared_data: Optional[bool] = None) -> ShareInfo:
        ...
        res = self._api.do(
            "GET", f"/api/2.1/unity-catalog/shares/{name}", query=query, headers=headers
        )
        return ShareInfo.from_dict(res)
    ...
    def list(
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.1/unity-catalog/shares", query=query, headers=headers
            )
            if "shares" in json:
                for v in json["shares"]:
    ...
    def share_permissions(
        ...
        res = self._api.do(
            "GET", f"/api/2.1/unity-catalog/shares/{name}/permissions", query=query, headers=headers
        )
    ...
    def update(
        ...
        *,
        ...
        res = self._api.do(
            "PATCH", f"/api/2.1/unity-catalog/shares/{name}", body=body, headers=headers
        )
        return ShareInfo.from_dict(res)
