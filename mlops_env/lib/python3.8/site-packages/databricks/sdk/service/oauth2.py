...
class AccountFederationPolicyAPI:
    ...
    def create(
        self, *, policy: Optional[FederationPolicy] = None, policy_id: Optional[str] = None
    ) -> FederationPolicy:
...
class PublishedAppIntegrationAPI:
    ...
    def update(
        self, integration_id: str, *, token_access_policy: Optional[TokenAccessPolicy] = None
    ):
...
class ServicePrincipalSecretsAPI:
    ...
    def list(
        self, service_principal_id: int, *, page_token: Optional[str] = None
    ) -> Iterator[SecretInfo]:
