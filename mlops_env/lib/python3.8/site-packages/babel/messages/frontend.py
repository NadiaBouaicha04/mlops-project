        ...
        if not self.input_file:
            if self.locale:
                po_files.append(
                    (
                        self.locale,
                        os.path.join(self.directory, self.locale, "LC_MESSAGES", f"{domain}.po"),
                    )
                )
                mo_files.append(
                    os.path.join(self.directory, self.locale, "LC_MESSAGES", f"{domain}.mo")
                )
            else:
                for locale in os.listdir(self.directory):
                    ...
                    if os.path.exists(po_file):
                        ...
                        mo_files.append(
                            os.path.join(self.directory, locale, "LC_MESSAGES", f"{domain}.mo")
                        )
        else:
