...
class Tests(unittest.TestCase):
    def test_case(self):
        ...
        for pat, res in tests:
            res.sort()
            a = sorted(
                wildcard.list_namespace(ns, "all", pat, ignore_case=False, show_all=False).keys()
            )
    ...
    def test_case_showall(self):
        ...
        for pat, res in tests:
            res.sort()
            a = sorted(
                wildcard.list_namespace(ns, "all", pat, ignore_case=False, show_all=True).keys()
            )
            self.assertEqual(a, res)
    ...
    def test_nocase(self):
        ...
        for pat, res in tests:
            res.sort()
            a = sorted(
                wildcard.list_namespace(ns, "all", pat, ignore_case=True, show_all=False).keys()
            )
            self.assertEqual(a, res)
    ...
    def test_nocase_showall(self):
        ...
        for pat, res in tests:
            res.sort()
            a = sorted(
                wildcard.list_namespace(ns, "all", pat, ignore_case=True, show_all=True).keys()
            )
            a.sort()
            self.assertEqual(a, res)
