...
def test_objecttype_camelcase():
    ...
    assert isinstance(foo_field, GraphQLField)
    assert foo_field.args == {
        "barFoo": GraphQLArgument(GraphQLString, default_value=Undefined, out_name="bar_foo")
    }
...
def test_objecttype_camelcase_disabled():
    ...
    assert isinstance(foo_field, GraphQLField)
    assert foo_field.args == {
        "bar_foo": GraphQLArgument(GraphQLString, default_value=Undefined, out_name="bar_foo")
    }
