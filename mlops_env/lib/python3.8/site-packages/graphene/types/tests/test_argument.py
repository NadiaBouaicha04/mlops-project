...
def test_to_arguments_deprecated():
    ...
    my_args = to_arguments(args)
    assert my_args == {
        "unmounted_arg": Argument(String, required=False, deprecation_reason="deprecated"),
    }


def test_to_arguments_required_deprecated():
    args = {"unmounted_arg": String(required=True, name="arg", deprecation_reason="deprecated")}
...
def test_to_arguments_raises_if_field():
    ...
    assert str(exc_info.value) == (
        "Expected arg_string to be Argument, but received Field. Try using " "Argument(String)."
    )
