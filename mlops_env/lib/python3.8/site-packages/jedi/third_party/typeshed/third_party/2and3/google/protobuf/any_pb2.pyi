...
class Any(
    google___protobuf___message___Message, google___protobuf___internal___well_known_types___Any
):
    ...
    def ClearField(
        self, field_name: typing_extensions___Literal["type_url", b"type_url", "value", b"value"]
    ) -> None: ...
