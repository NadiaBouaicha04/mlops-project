...
class FileDescriptorSet(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal["file", b"file"]) -> None: ...
...
class DescriptorProto(google___protobuf___message___Message):
    ...
    class ReservedRange(google___protobuf___message___Message):
        ...
        def HasField(
            self, field_name: typing_extensions___Literal["end", b"end", "start", b"start"]
        ) -> builtin___bool: ...
        def ClearField(
            self, field_name: typing_extensions___Literal["end", b"end", "start", b"start"]
        ) -> None: ...
    ...
    def HasField(
        self, field_name: typing_extensions___Literal["name", b"name", "options", b"options"]
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
...
class ExtensionRangeOptions(google___protobuf___message___Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal["uninterpreted_option", b"uninterpreted_option"],
    ) -> None: ...
...
class FieldOptions(google___protobuf___message___Message):
    ...
    class _CType(
        google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[FieldOptions.CTypeValue]
    ):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
...
class SourceCodeInfo(google___protobuf___message___Message):
    ...
    class Location(google___protobuf___message___Message):
        ...
        leading_detached_comments: (
            google___protobuf___internal___containers___RepeatedScalarFieldContainer[typing___Text]
        ) = (...)
