...
if sys.version_info >= (3, 8):
    ...
    def dump(
        obj: Any, file: IO[bytes], protocol: Optional[int] = ..., *, fix_imports: bool = ...
    ) -> None: ...
...
_reducedtype = Union[
    ...
    Tuple[
        Callable[..., Any], Tuple[Any, ...], Any, Optional[Iterator[Any]], Optional[Iterator[Any]]
    ],
]
...
class Pickler:
    ...
    if sys.version_info >= (3, 8):
        ...
        def __init__(
            self, file: IO[bytes], protocol: Optional[int] = ..., *, fix_imports: bool = ...
        ) -> None: ...
    else:
