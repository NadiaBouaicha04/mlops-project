...
class int:
    @overload
    def __new__(
        cls: Type[_T], x: Union[str, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc] = ...
    ) -> _T: ...
    @overload
...
class float:
    def __new__(
        cls: Type[_T], x: Union[SupportsFloat, _SupportsIndex, str, bytes, bytearray] = ...
    ) -> _T: ...
...
class str(Sequence[str]):
    ...
    def title(self) -> str: ...
    def translate(
        self, __table: Union[Mapping[int, Union[int, str, None]], Sequence[Union[int, str, None]]]
    ) -> str: ...
    def upper(self) -> str: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    def count(
        self, __sub: Union[bytes, int], __start: Optional[int] = ..., __end: Optional[int] = ...
    ) -> int: ...
...
def isinstance(
    __obj: object, __class_or_tuple: Union[type, Tuple[Union[type, Tuple[Any, ...]], ...]]
) -> bool: ...
def issubclass(
...
@overload
def sorted(
    __iterable: Iterable[_T], *, key: Callable[[_T], SupportsLessThan], reverse: bool = ...
) -> List[_T]: ...
