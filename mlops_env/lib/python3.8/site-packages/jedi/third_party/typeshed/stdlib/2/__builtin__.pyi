...
class int:
    @overload
    def __new__(
        cls: Type[_T], x: Union[Text, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc] = ...
    ) -> _T: ...
    @overload
...
class float:
    def __new__(
        cls: Type[_T], x: Union[SupportsFloat, _SupportsIndex, Text, bytes, bytearray] = ...
    ) -> _T: ...
...
def compile(
    source: Union[Text, mod], filename: Text, mode: Text, flags: int = ..., dont_inherit: int = ...
) -> Any: ...
