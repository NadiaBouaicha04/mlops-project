...
class Element(MutableSequence[Element]):
    ...
    def makeelement(
        self, __tag: _str_argument_type, __attrib: Dict[_str_argument_type, _str_argument_type]
    ) -> Element: ...
...
if sys.version_info >= (3, 4):
    class XMLPullParser:
        def __init__(
            self, events: Optional[Sequence[str]] = ..., *, _parser: Optional[XMLParser] = ...
        ) -> None: ...
...
class TreeBuilder:
    ...
    def start(
        self, __tag: _parser_input_type, __attrs: Dict[_parser_input_type, _parser_input_type]
    ) -> Element: ...
