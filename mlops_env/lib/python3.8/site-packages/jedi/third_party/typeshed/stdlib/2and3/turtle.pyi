...
class TurtleScreen(TurtleScreenBase):
    ...
    def onclick(
        self, fun: Callable[[float, float], Any], btn: int = ..., add: Optional[Any] = ...
    ) -> None: ...
...
class RawTurtle(TPen, TNavigator):
    ...
    def write(
        self, arg: object, move: bool = ..., align: str = ..., font: Tuple[str, int, str] = ...
    ) -> None: ...
    ...
    getpen = getturtle
    def onclick(
        self, fun: Callable[[float, float], Any], btn: int = ..., add: Optional[bool] = ...
    ) -> None: ...
    def onrelease(
        self, fun: Callable[[float, float], Any], btn: int = ..., add: Optional[bool] = ...
    ) -> None: ...
