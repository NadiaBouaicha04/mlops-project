...
if sys.platform == "win32":
    ...
    class Control:
        ...
        def event(
            self, event: str, argument: str, condition: str = ..., ordering: Optional[int] = ...
        ) -> None: ...
    ...
    class RadioButtonGroup(Control):
        ...
        def add(
            self, name: str, x: int, y: int, w: int, h: int, text: str, value: Optional[str] = ...
        ) -> None: ...
    ...
    class Dialog:
        ...
        def text(
            self, name: str, x: int, y: int, w: int, h: int, attr: int, text: Optional[str]
        ) -> Control: ...
        def bitmap(
