...
class Subquery(Expression):
    ...
    extra: Dict[Any, Any] = ...
    def __init__(
        self, queryset: _BaseQuerySet, output_field: Optional[_OutputField] = ..., **extra: Any
    ) -> None: ...
...
class RawSQL(Expression):
    ...
    sql: str
    def __init__(
        self, sql: str, params: Sequence[Any], output_field: Optional[_OutputField] = ...
    ) -> None: ...
...
class Func(SQLiteNumericMixin, Expression):
    ...
    extra: Dict[Any, Any] = ...
    def __init__(
        self, *expressions: Any, output_field: Optional[_OutputField] = ..., **extra: Any
    ) -> None: ...
