...
class CompiledValue(Value):
    ...
    def py__getitem__(self, index_value_set, contextualized_node):
        ...
        return ValueSet(
            create_from_access_path(self.inference_state, access) for access in all_access_paths
        )
    ...
    def execute_annotation(self):
        ...
        arguments = [
            ValueSet([create_from_access_path(self.inference_state, path)]) for path in args
        ]
        if name == "Union":
