...
class ExecutedParamName(ParamName):
    ...
    def matches_signature(self):
        ...
        debug.dbg(
            "param compare %s: %s <=> %s", matches, argument_values, annotations, color="BLUE"
        )
        return matches
...
def get_executed_param_names_and_issues(function_value, arguments):
    ...
    for param in funcdef.get_params():
        ...
        result_params.append(
            ExecutedParamName(function_value, arguments, param, result_arg, is_default=is_default)
        )
    ...
    if keys_only:
        ...
        for k in set(param_dict) - set(keys_used):
            ...
            if not (
                non_matching_keys or had_multiple_value_error or param.star_count or param.default
            ):
