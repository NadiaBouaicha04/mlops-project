...
def _get_explicit_environ_credentials(quota_project_id=None):
    ...
    if explicit_file is not None:
        ...
        credentials._cred_file_path = (
            f"{explicit_file} file via the GOOGLE_APPLICATION_CREDENTIALS environment variable"
        )
    ...
    try:
        ...
        if source_credentials_type == _AUTHORIZED_USER_TYPE:
            ...
            raise exceptions.InvalidType(
                "source credential of type {} is not supported.".format(source_credentials_type)
            )
