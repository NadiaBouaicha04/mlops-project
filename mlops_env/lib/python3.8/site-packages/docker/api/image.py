...
class ImageApiMixin:
    ...
    def import_image(
        self, src=None, repository=None, tag=None, image=None, changes=None, stream_src=False
    ):
        """
    ...
    def pull(
        ...
        response = self._post(
            self._url("/images/create"), params=params, headers=headers, stream=stream, timeout=None
        )
