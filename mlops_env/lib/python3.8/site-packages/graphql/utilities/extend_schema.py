...
def extend_schema_impl(
    ...
    def build_interface_type(
        ...
        extension_nodes = type_extensions_map[ast_node.name.value]
        all_nodes: List[Union[InterfaceTypeDefinitionNode, InterfaceTypeExtensionNode]] = [
            ast_node,
            *extension_nodes,
        ]
        return GraphQLInterfaceType(
    ...
    return GraphQLSchemaKwargs(
        ...
        description=(
            schema_def.description.value if schema_def and schema_def.description else None
        ),
        extensions={},
