...
__Directive: GraphQLObjectType = GraphQLObjectType(
    ...
    fields=lambda: {
        ...
        "args": GraphQLField(
            ...
            args={"includeDeprecated": GraphQLArgument(GraphQLBoolean, default_value=False)},
...
__Type: GraphQLObjectType = GraphQLObjectType(
    ...
    fields=lambda: {
        ...
        "specifiedByURL": GraphQLField(GraphQLString, resolve=TypeResolvers.specified_by_url),
        "fields": GraphQLField(
...
__Field: GraphQLObjectType = GraphQLObjectType(
    ...
    " and a return type.",
    fields=lambda: {
        "name": GraphQLField(GraphQLNonNull(GraphQLString), resolve=FieldResolvers.name),
        ...
        "deprecationReason": GraphQLField(GraphQLString, resolve=FieldResolvers.deprecation_reason),
    },
)
...
__InputValue: GraphQLObjectType = GraphQLObjectType(
    ...
    fields=lambda: {
        "name": GraphQLField(GraphQLNonNull(GraphQLString), resolve=InputValueFieldResolvers.name),
        "description": GraphQLField(GraphQLString, resolve=InputValueFieldResolvers.description),
        "type": GraphQLField(GraphQLNonNull(__Type), resolve=InputValueFieldResolvers.type),
...
__EnumValue: GraphQLObjectType = GraphQLObjectType(
    ...
    " string.",
    fields=lambda: {
        "name": GraphQLField(GraphQLNonNull(GraphQLString), resolve=lambda item, _info: item[0]),
        "description": GraphQLField(GraphQLString, resolve=lambda item, _info: item[1].description),
        "isDeprecated": GraphQLField(
            GraphQLNonNull(GraphQLBoolean),
...
__TypeKind: GraphQLEnumType = GraphQLEnumType(
    ...
    values={
        "SCALAR": GraphQLEnumValue(TypeKind.SCALAR, description="Indicates this type is a scalar."),
        "OBJECT": GraphQLEnumValue(
            TypeKind.OBJECT,
