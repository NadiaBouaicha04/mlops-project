...
backward_connection_args: GraphQLArgumentMap = {
    ...
    "last": GraphQLArgument(GraphQLInt, description="Returns the last n items from the list."),
}
...
def connection_definitions(
    ...
    connection_type = GraphQLObjectType(
        ...
        fields=lambda: {
            ...
            "edges": GraphQLField(GraphQLList(edge_type), description="A list of edges."),
